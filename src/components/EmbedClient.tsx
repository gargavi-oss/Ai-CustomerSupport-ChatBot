                ...
                <div className='mt-14'>
                    ...
                    <div className='rounded-xl border border-zinc-300 bg-white shadow-md overflow-hidden'>
                        ...
                        <div className='relative h-64 sm:h-72 p-6 text-zinc-400 text-sm'>
                            ...
                            <div className='absolute bottom-24 right-6 bg-white rounded-xl shadow-xl border border-zinc-200 overflow-hidden'>
                                <div className='bg-black text-white text-xs px-3 py-2 flex justify-between items-center gap-8'>
                                    <span>
                                    💬 Customer Support
                                    </span>
                                    <span>
